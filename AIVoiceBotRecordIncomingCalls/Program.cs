...
namespace AIVoiceBotRecordIncomingCalls
{
    ...
    class SIPServer
    {
        ...
        private static VoIPMediaSession CreateRtpSession(SIPUserAgent ua, string dst, int bindPort)
        {
            ...
            rtpAudioSession.OnRtpPacketReceived += (ep, type, rtp) =>
            {
                ...
                // Get the 'to' user information (i.e., the user of this application)
                ...
                OnRtpPacketReceived(ua, ep, type, rtp);
            };
    ...
    RTPPacket rtpPacket)
        {
            ...
            // Get the Call-ID, or generate one if it doesn't exist
            ...
            // Get or create the state specific to each call
